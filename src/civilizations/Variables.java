...
public interface Variables {
    // Recursos base para el primer ejército enemigo
    int IRON_BASE_ENEMY_ARMY = 26000;
    int WOOD_BASE_ENEMY_ARMY = 180000;
    int FOOD_BASE_ENEMY_ARMY = 70000;
    int ENEMY_FLEET_INCREASE = 6; // porcentaje de incremento
    ...
    // Costes de tecnologías (actualización)
    ...
    // Arrays de costes (índices: 0 Swordsman,1 Spearman,2 Crossbow,3 Cannon,
    ...
    // Incrementos por nivel de tecnología
    ...
    int CHANCE_GENERATING_WASTE_SHORDSMAN = 55;
    ...
    int CHANCE_ATTACK_AGAIN_SHORDSMAN = 3;
    ...
    int BATTLE_STOP_PERCENTAGE = 20; // Porcentaje de unidades restantes para terminar batalla
}